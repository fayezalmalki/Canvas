  ...
  if (totalImages === 0) {
    return (
      <div className="rounded-lg border border-border bg-card p-6 text-center">
        ...
        <p className="text-sm text-muted-foreground">No images found across crawled pages</p>
      </div>
    );
  }
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex items-center gap-2">
        ...
        >
          Sort: {sortBy === "most-images" ? "Most images" : "Most missing alt"}
        </button>
      </div>
